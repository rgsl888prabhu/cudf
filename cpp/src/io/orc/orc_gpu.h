...
struct ColumnDesc {
  ...
  uint32_t base_parent_num_rows;           // main parent number of rows
...
struct RowGroup {
  ...
  uint32_t start_row;       // number of rows in rowgroup
  uint32_t num_child_rows;  // number of rows of children in rowgroup
};
